...
const userSchema = new Schema({
  ...
  professionalTitle: { type: String, trim: true }, specializations: [{ type: String, trim: true }], isOnline: { type: Boolean, default: false }, isAvailable: { type: Boolean, default: true },
