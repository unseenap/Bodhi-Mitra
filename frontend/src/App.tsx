...
import { LiveQueue, PsychologistProfile, PsychologistSessions } from "./pages/psychologist/PsychologistPages";
import { ContentPage, ExpertsPage, FaqPage, NotFoundPage } from "./pages/public/ContentPages";
...
export default function App() {
  return <BrowserRouter><AuthProvider><Routes>
    ...
    <Route element={<ProtectedRoute role="psychologist" />}><Route element={<DashboardLayout />}>
      ...
      <Route path="psychologist/session/:sessionId" element={<SessionRoom />} />
    </Route></Route>
    <Route element={<ProtectedRoute role="admin" />}><Route element={<DashboardLayout />}>
      <Route path="admin" element={<AdminOverview />} />
      <Route path="admin/psychologists" element={<PsychologistManagement />} />
